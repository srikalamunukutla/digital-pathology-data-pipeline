...
.
.TH "COMPUTE_INSTANCE" "1" "May 27, 2025" "3.57.0" "OCI CLI Command Reference"
.SH NAME
compute_instance \- 
.
...
.INDENT 0.0
.TP
.B \-\-placement\-constraint\-details [complex type]
.UNINDENT
.sp
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
...
.UNINDENT
.UNINDENT
.SS \fBlaunch\-instance\-compute\-bare\-metal\-host\-placement\-constraint\-details\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.INDENT 0.0
.TP
.B \-\-placement\-constraint\-details\-compute\-bare\-metal\-host\-id [text]
.UNINDENT
.sp
...
.INDENT 0.0
.TP
.B \-\-create\-vnic\-details [complex type]
.UNINDENT
.sp
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
...
.UNINDENT
.sp
Deprecated. Instead use \fIhostnameLabel\fP in \fI\%CreateVnicDetails\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/iaas/latest/CreateVnicDetails/\fP>\&. If you provide both, the values must match.
.INDENT 0.0
.TP
.B \-\-image\-id [text]
.UNINDENT
.sp
Deprecated. Use \fIsourceDetails\fP with \fI\%InstanceSourceViaImageDetails\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/iaas/latest/requests/InstanceSourceViaImageDetails\fP> source type instead. If you specify values for both, the values must match.
.INDENT 0.0
.TP
.B \-\-instance\-configuration\-id [text]
.UNINDENT
...
.INDENT 0.0
.IP \(bu 2
Provide information to \fI\%Cloud\-Init\fP <\fBhttps://cloudinit.readthedocs.org/en/latest/\fP>   to be used for various system initialization tasks.
.IP \(bu 2
Get information about the instance, including the custom metadata that you   provide when you launch the instance.
.UNINDENT
.INDENT 0.0
.INDENT 3.5
\fBProviding Cloud\-Init Metadata\fP
.sp
You can use the following metadata key names to provide information to  Cloud\-Init:
.sp
\fB“ssh_authorized_keys”\fP \- Provide one or more public SSH keys to be  included in the \fI~/.ssh/authorized_keys\fP file for the default user on the  instance. Use a newline character to separate multiple keys. The SSH  keys must be in the format necessary for the \fIauthorized_keys\fP file, as shown  in the example below.
.sp
\fB“user_data”\fP \- Provide your own base64\-encoded data to be used by  Cloud\-Init to run custom scripts or provide custom Cloud\-Init configuration. For  information about how to take advantage of user data, see the  \fI\%Cloud\-Init Documentation\fP <\fBhttp://cloudinit.readthedocs.org/en/latest/topics/format.html\fP>\&.
.sp
\fBMetadata Example\fP
.INDENT 0.0
.INDENT 3.5
“metadata” : {          “quake_bot_level” : “Severe”,          “ssh_authorized_keys” : “ssh\-rsa <your_public_SSH_key>== rsa\-key\-20160227”,          “user_data” : “<your_public_SSH_key>==”       }  \fBGetting Metadata on the Instance\fP
.UNINDENT
.UNINDENT
.sp
...
.INDENT 0.0
.INDENT 3.5
curl \-H “Authorization: Bearer Oracle” \fI\%http://169.254.169.254/opc/v2/instance/\fP      curl \-H “Authorization: Bearer Oracle” \fI\%http://169.254.169.254/opc/v2/instance/metadata/\fP      curl \-H “Authorization: Bearer Oracle” \fI\%http://169.254.169.254/opc/v2/instance/metadata\fP/<any\-key\-name>
.UNINDENT
.UNINDENT
.sp
...
.UNINDENT
.sp
Deprecated. Instead use \fIsubnetId\fP in \fI\%CreateVnicDetails\fP <\fBhttps://docs.cloud.oracle.com/api/#/en/iaas/latest/CreateVnicDetails/\fP>\&. At least one of them is required; if you provide both, the values must match.
.INDENT 0.0
.TP
.B \-\-wait\-for\-state [text]
.UNINDENT
...
.UNINDENT
.UNINDENT
.SS \fBlaunch\-instance\-host\-group\-placement\-constraint\-details\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.INDENT 0.0
.TP
.B \-\-placement\-constraint\-details\-compute\-host\-group\-id [text]
.UNINDENT
.sp
