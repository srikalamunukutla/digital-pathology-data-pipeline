...
.
.TH "DB_DATABASE" "1" "May 27, 2025" "3.57.0" "OCI CLI Command Reference"
.SH NAME
db_database \- 
.
...
.UNINDENT
.UNINDENT
.SS \fBchange\-to\-external\-hsm\-key\-location\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.UNINDENT
.UNINDENT
.SS \fBconvert\-to\-new\-pdb\-precheck\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.UNINDENT
.UNINDENT
.SS \fBconvert\-to\-pdb\-sync\-rollback\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.UNINDENT
.UNINDENT
.SS \fBcreate\-database\-create\-stand\-by\-database\-details\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.ft C
    ...
    oci db database create\-database\-create\-stand\-by\-database\-details \-\-database file://database.json
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBcreate\-database\-from\-backup\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.ft C
    ...
    oci db database create\-database\-from\-backup \-\-database file://database.json
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBcreate\-from\-backup\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.UNINDENT
.UNINDENT
.SS \fBcreate\-standby\-database\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.UNINDENT
.sp
The \fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP> of the source (primary) database for the Data Guard group.
.SS Optional Parameters
.INDENT 0.0
.TP
.B \-\-db\-unique\-name [text]
.UNINDENT
.sp
Specifies the \fIDB_UNIQUE_NAME\fP of the standby database to be created.
.INDENT 0.0
.TP
...
.sp
\fBIMPORTANT\fP \- The protection mode is required for first standby to be created.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
...
.UNINDENT
.sp
Specifies a prefix for the \fIOracle SID\fP of the standby database to be created.
.INDENT 0.0
.TP
.B \-\-source\-tde\-wallet\-password [text]
.UNINDENT
.sp
...
.UNINDENT
.sp
The redo transport type to use for the standby database to be created.  Valid values depend on the specified \fIprotectionMode\fP:
.INDENT 0.0
.IP \(bu 2
...
.UNINDENT
.UNINDENT
.SS \fBdisable\-database\-management\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.UNINDENT
.UNINDENT
.SS \fBenable\-database\-management\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.UNINDENT
.UNINDENT
.SS \fBlist\-pdb\-conversion\-history\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.UNINDENT
.UNINDENT
.SS \fBmodify\-database\-management\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.ft C
    ...
    export admin_password=<substitute\-value\-of\-admin_password> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/db/database/create.html#cmdoption\-admin\-password
    export db_name=<substitute\-value\-of\-db_name> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/db/database/create.html#cmdoption\-db\-name
    export one_off_patches=<substitute\-value\-of\-one_off_patches> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/db/database/patch.html#cmdoption\-one\-off\-patches

    db_home_id=$(oci db db\-home create \-\-db\-system\-id $db_system_id \-\-query data.id \-\-raw\-output)

    database_id=$(oci db database create \-\-admin\-password $admin_password \-\-db\-home\-id $db_home_id \-\-db\-name $db_name \-\-db\-system\-id $db_system_id \-\-query data.id \-\-raw\-output)

    oci db database patch \-\-database\-id $database_id \-\-one\-off\-patches $one_off_patches
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBreinstate\-data\-guard\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.UNINDENT
.UNINDENT
.SS \fBset\-oci\-db\-key\-version\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.UNINDENT
.UNINDENT
.SS \fBswitch\-over\-data\-guard\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.SS Description
.sp
Update an existing Data Guard member. A Data Guard member represents the replication relationship between the specified database and a standby database. For more information, see \fI\%Using Oracle Data Guard\fP <\fBhttps://docs.oracle.com/en/cloud/paas/autonomous-database/dedicated/adbau/#articletitle.html\fP>\&.
.SS Usage
.INDENT 0.0
.INDENT 3.5
.sp
...
.UNINDENT
.UNINDENT
.SS \fBupgrade\-with\-database\-software\-image\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.UNINDENT
.UNINDENT
.SS \fBupgrade\-with\-db\-version\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.UNINDENT
.sp
A valid Oracle Database version. To get a list of supported versions, use the \fI\%ListDbVersions\fP <\fBhttps://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/db/version/list.html\fP> operation.
.SS Optional Parameters
.INDENT 0.0
.TP
.B \-\-from\-json [text]
