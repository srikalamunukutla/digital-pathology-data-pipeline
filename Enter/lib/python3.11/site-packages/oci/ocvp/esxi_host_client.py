...
class EsxiHostClient(object):
    ...
    def create_esxi_host(self, create_esxi_host_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.153.0/ocvp/create_esxi_host.py.html>`__ to see an example of how to use create_esxi_host API.
        """
    ...
    def delete_esxi_host(self, esxi_host_id, **kwargs):
        ...
        **Note:** If you delete EXSi hosts from the SDDC to total less than 3,
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.153.0/ocvp/delete_esxi_host.py.html>`__ to see an example of how to use delete_esxi_host API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_esxi_host(self, esxi_host_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.153.0/ocvp/get_esxi_host.py.html>`__ to see an example of how to use get_esxi_host API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['esxiHostId']
        resource_path = "/esxiHosts/{esxiHostId}"
    ...
    def inplace_upgrade(self, esxi_host_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.153.0/ocvp/inplace_upgrade.py.html>`__ to see an example of how to use inplace_upgrade API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['esxiHostId']
    ...
    def list_esxi_hosts(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.153.0/ocvp/list_esxi_hosts.py.html>`__ to see an example of how to use list_esxi_hosts API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/esxiHosts"
    ...
    def replace_host(self, esxi_host_id, replace_host_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.153.0/ocvp/replace_host.py.html>`__ to see an example of how to use replace_host API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['esxiHostId']
    ...
    def swap_billing(self, esxi_host_id, swap_billing_host_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.153.0/ocvp/swap_billing.py.html>`__ to see an example of how to use swap_billing API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def update_esxi_host(self, esxi_host_id, update_esxi_host_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.153.0/ocvp/update_esxi_host.py.html>`__ to see an example of how to use update_esxi_host API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['esxiHostId']
        resource_path = "/esxiHosts/{esxiHostId}"
