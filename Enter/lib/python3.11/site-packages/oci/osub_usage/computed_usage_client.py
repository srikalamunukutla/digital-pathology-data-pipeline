...
class ComputedUsageClient(object):
    ...
    def get_computed_usage(self, computed_usage_id, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.153.0/osubusage/get_computed_usage.py.html>`__ to see an example of how to use get_computed_usage API.
        """
    ...
    def list_computed_usage_aggregateds(self, compartment_id, subscription_id, time_from, time_to, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.153.0/osubusage/list_computed_usage_aggregateds.py.html>`__ to see an example of how to use list_computed_usage_aggregateds API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_computed_usages(self, compartment_id, subscription_id, time_from, time_to, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.153.0/osubusage/list_computed_usages.py.html>`__ to see an example of how to use list_computed_usages API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId', 'subscriptionId', 'timeFrom', 'timeTo']
