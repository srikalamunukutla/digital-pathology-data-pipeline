...
class ThreatintelClient(object):
    ...
    def get_indicator(self, indicator_id, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.153.0/threatintelligence/get_indicator.py.html>`__ to see an example of how to use get_indicator API.
        """
    ...
    def list_indicator_counts(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.153.0/threatintelligence/list_indicator_counts.py.html>`__ to see an example of how to use list_indicator_counts API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_indicators(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.153.0/threatintelligence/list_indicators.py.html>`__ to see an example of how to use list_indicators API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
    ...
    def list_threat_types(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.153.0/threatintelligence/list_threat_types.py.html>`__ to see an example of how to use list_threat_types API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
    ...
    def summarize_indicators(self, compartment_id, summarize_indicators_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.153.0/threatintelligence/summarize_indicators.py.html>`__ to see an example of how to use summarize_indicators API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
