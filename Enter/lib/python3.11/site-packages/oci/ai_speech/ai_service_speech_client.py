...
class AIServiceSpeechClient(object):
    ...
    def cancel_transcription_job(self, transcription_job_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.153.0/aispeech/cancel_transcription_job.py.html>`__ to see an example of how to use cancel_transcription_job API.
        """
    ...
    def cancel_transcription_task(self, transcription_job_id, transcription_task_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.153.0/aispeech/cancel_transcription_task.py.html>`__ to see an example of how to use cancel_transcription_task API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_customization_compartment(self, customization_id, change_customization_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.153.0/aispeech/change_customization_compartment.py.html>`__ to see an example of how to use change_customization_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_transcription_job_compartment(self, transcription_job_id, change_transcription_job_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.153.0/aispeech/change_transcription_job_compartment.py.html>`__ to see an example of how to use change_transcription_job_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['transcriptionJobId']
    ...
    def create_customization(self, create_customization_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.153.0/aispeech/create_customization.py.html>`__ to see an example of how to use create_customization API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_realtime_session_token(self, create_realtime_session_token_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.153.0/aispeech/create_realtime_session_token.py.html>`__ to see an example of how to use create_realtime_session_token API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_transcription_job(self, create_transcription_job_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.153.0/aispeech/create_transcription_job.py.html>`__ to see an example of how to use create_transcription_job API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_customization(self, customization_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.153.0/aispeech/delete_customization.py.html>`__ to see an example of how to use delete_customization API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['customizationId']
    ...
    def delete_transcription_job(self, transcription_job_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.153.0/aispeech/delete_transcription_job.py.html>`__ to see an example of how to use delete_transcription_job API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['transcriptionJobId']
    ...
    def get_customization(self, customization_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.153.0/aispeech/get_customization.py.html>`__ to see an example of how to use get_customization API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['customizationId']
        resource_path = "/customizations/{customizationId}"
    ...
    def get_transcription_job(self, transcription_job_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.153.0/aispeech/get_transcription_job.py.html>`__ to see an example of how to use get_transcription_job API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['transcriptionJobId']
        resource_path = "/transcriptionJobs/{transcriptionJobId}"
    ...
    def get_transcription_task(self, transcription_job_id, transcription_task_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.153.0/aispeech/get_transcription_task.py.html>`__ to see an example of how to use get_transcription_task API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['transcriptionJobId', 'transcriptionTaskId']
    ...
    def list_customizations(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.153.0/aispeech/list_customizations.py.html>`__ to see an example of how to use list_customizations API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/customizations"
    ...
    def list_transcription_jobs(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.153.0/aispeech/list_transcription_jobs.py.html>`__ to see an example of how to use list_transcription_jobs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/transcriptionJobs"
    ...
    def list_transcription_tasks(self, transcription_job_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.153.0/aispeech/list_transcription_tasks.py.html>`__ to see an example of how to use list_transcription_tasks API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['transcriptionJobId']
    ...
    def list_voices(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.153.0/aispeech/list_voices.py.html>`__ to see an example of how to use list_voices API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def synthesize_speech(self, synthesize_speech_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.153.0/aispeech/synthesize_speech.py.html>`__ to see an example of how to use synthesize_speech API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def update_customization(self, customization_id, update_customization_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.153.0/aispeech/update_customization.py.html>`__ to see an example of how to use update_customization API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['customizationId']
        resource_path = "/customizations/{customizationId}"
    ...
    def update_transcription_job(self, transcription_job_id, update_transcription_job_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.153.0/aispeech/update_transcription_job.py.html>`__ to see an example of how to use update_transcription_job API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['transcriptionJobId']
        resource_path = "/transcriptionJobs/{transcriptionJobId}"
